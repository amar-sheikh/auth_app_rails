...
class TransactionsTest < ApplicationSystemTestCase
  ...
  test "should create transaction" do
    ...
    fill_in "Additional info", with: @transaction.additional_info
    fill_in "Address", with: @transaction.address_id
    fill_in "Idempotency key", with: @transaction.idempotency_key
